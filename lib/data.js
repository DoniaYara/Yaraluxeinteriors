...
export const PROJECTS = [
  ...
  { title: "The Velvet Noir", img: "2026/05/bb1-1.jpg", thumb: "2026/05/bb1-1-720x720.jpg", cats: DFI },
...
export function asProject(item) {
  if (Array.isArray(item)) {
    return { title: item[0], img: item[1], cats: String(item[2]).split(/\s+/).filter(Boolean) };
  }
  return item;
}
